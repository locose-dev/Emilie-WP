				...
				<div class="row">
					<div class="col-xs-12">
						<div class="slide-caption">
							...
							<a href="<?php echo esc_url($eyepress_btn_url_one); ?>" class="marbnt btn border"><?php echo esc_html($eyepress_btn_text_one); ?></a>
							<?php
							endif;
							 if($eyepress_btn_text_two):
							  ?>
							<a href="<?php echo esc_url($eyepress_btn_url_two); ?>" class="marbnt2 btn border"><?php echo esc_html($eyepress_btn_text_two); ?></a>
							<?php endif; ?>
						</div>
					</div>
				</div>
