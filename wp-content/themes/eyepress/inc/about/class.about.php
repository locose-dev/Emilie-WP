...
if ( ! class_exists( 'eyepress_About' ) ) {
    ...
    return add_query_arg(
		...
		public function style_and_scripts( $hook_suffix ) {
			...
			wp_enqueue_style( 'about-page-css', get_template_directory_uri() . '/inc/about/css/about.min.css', array(),'1.2.2','all' );
			wp_enqueue_script( 'eye-notice-js', get_template_directory_uri() . '/inc/about/js/notice.js', array('jquery'), '1.6.3', true );
